...
TEST_F(ClipperPbCube, ClipperPushBroomCameraNacTest) {
  ...
  // Upper Left
  EXPECT_TRUE(cam->SetImage(1, 1, naif));
  ...
  // Upper Right
  EXPECT_TRUE(cam->SetImage(1, 1000, naif));
  ...
  // Lower Right
  EXPECT_TRUE(cam->SetImage(4096, 1000, naif));
  ...
  // Lower Left
  EXPECT_TRUE(cam->SetImage(4096, 1, naif));
...
TEST_F(ClipperPbCube, ClipperPushBroomCameraWacTest) {
  ...
  // Top
  EXPECT_TRUE(cam->SetImage(2130, 30, naif));
  ...
  // Bottom
  EXPECT_TRUE(cam->SetImage(2130, 2030, naif));
  ...
  // Right
  EXPECT_TRUE(cam->SetImage(3580, 1024, naif));
  ...
  // Left
  EXPECT_TRUE(cam->SetImage(544, 1024, naif));
