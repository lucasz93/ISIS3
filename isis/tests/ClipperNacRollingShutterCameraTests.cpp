...
TEST_F(ClipperNacRsCube, ClipperNacRsCameraUnitTest) {
  ...
  EXPECT_TRUE(cam->SetImage(145, 161, naif));
  ...
  EXPECT_TRUE(cam->SetImage(3655, 157, naif));
  ...
  EXPECT_TRUE(cam->SetImage(289, 1767, naif));
  ...
  EXPECT_TRUE(cam->SetImage(3767, 1579, naif));
