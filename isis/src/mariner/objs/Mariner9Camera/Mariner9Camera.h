#ifndef Mariner9Camera_h
#define Mariner9Camera_h
...
namespace Isis {
  /**
   * @brief Mariner9 Camera Model
   *
   * This is the camera model for both mariner9, both cameras A (wide angle)
   * and B (narrow angle).
   *
   ...
   */
  class Mariner9Camera : public FramingCamera {
    public:
      Mariner9Camera(Cube &cube);
      //! Destroys the Mariner9Camera Object
      ~Mariner9Camera() {};
       ...
       *         Kernel Frame ID
       */
      virtual int CkFrameId() const { return (-9000); }
