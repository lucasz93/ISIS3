...
namespace Isis {
  ...
  class Camera : public Sensor {
    public:
      ...
      virtual bool SetUniversalGround(NaifContextPtr naif, const double latitude, const double longitude,
                                      const double radius);
      virtual bool SetGround(NaifContextPtr naif, Latitude latitude, Longitude longitude);
      virtual bool SetGround(NaifContextPtr naif, const SurfacePoint & surfacePt);
