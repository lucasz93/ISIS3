...
namespace Isis {
  ...
  class Cube {
    public:
      ...
      void fromIsd(NaifContextPtr naif, const FileName &fileName, Pvl &label, nlohmann::json &isd, QString access);
      void fromIsd(NaifContextPtr naif, const FileName &fileName, FileName &labelFile, FileName &isdFile, QString access);
