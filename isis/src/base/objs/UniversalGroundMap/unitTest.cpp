...
int main(int argc, char *argv[]) {
  ...
  try {
    ...
    if (ugm.SetImage(1.0, 5.0, naif)) {
      cout << "Universal Latitude = " << ugm.UniversalLatitude() << endl;
      cout << "Universal Longitude = " << ugm.UniversalLongitude() << endl;

      if (ugm.SetUniversalGround(naif, ugm.UniversalLatitude(), ugm.UniversalLongitude())) {
        cout << "Sample = " << ugm.Sample() << endl;
        cout << "Line = " << ugm.Line() << endl << endl;
      }
      if (ugm.SetGround(naif,
          SurfacePoint(naif, Latitude(ugm.UniversalLatitude(), Angle::Degrees),
    ...
    if (ugm.SetImage(1204, 1056, naif)) {
      cout << "Universal Latitude = " << ugm.UniversalLatitude() << endl;
      cout << "Universal Longitude = " << ugm.UniversalLongitude() << endl;
    ...
    if (ugm2.SetImage(2.0, 5.0, naif)) {
      cerr << "Universal Latitude = " << ugm2.UniversalLatitude() << endl;
      cerr << "Universal Longitude = " << ugm2.UniversalLongitude() << endl;

      if (ugm2.SetUniversalGround(naif, ugm2.UniversalLatitude(), ugm2.UniversalLongitude())) {
    ...
    if (ugm2.SetImage(23040, 5.0, naif)) {
    ...
    if (ugm2.SetImage(2.0, 11520, naif)) {
      cout << "Universal Latitude = " << ugm2.UniversalLatitude() << endl;
      cout << "Universal Longitude = " << ugm2.UniversalLongitude() << endl;
    ...
    if (ugm2.SetImage(23040, 11520, naif)) {
      cout << "Universal Latitude = " << ugm2.UniversalLatitude() << endl;
      cout << "Universal Longitude = " << ugm2.UniversalLongitude() << endl;
    ...
    // Test all four corners to make sure the conversions are right
    cout << "For (1.0, 5.0) ..." << endl;
    if (ugm3.SetImage(1.0, 5.0, naif)) {
      cout << "Universal Latitude = " << ugm3.UniversalLatitude() << endl;
      cout << "Universal Longitude = " << ugm3.UniversalLongitude() << endl;

      if (ugm3.SetUniversalGround(naif, ugm3.UniversalLatitude(), ugm3.UniversalLongitude())) {
    ...
    if (ugm3.SetImage(1640, 20.0, naif)) {
      cout << "Universal Latitude = " << ugm3.UniversalLatitude() << endl;
      cout << "Universal Longitude = " << ugm3.UniversalLongitude() << endl;
    ...
    if (ugm3.SetImage(30.0, 415, naif)) {
      cout << "Universal Latitude = " << ugm3.UniversalLatitude() << endl;
      cout << "Universal Longitude = " << ugm3.UniversalLongitude() << endl;
    ...
    if (ugm3.SetImage(1700, 245, naif)) {
      cout << "Universal Latitude = " << ugm3.UniversalLatitude() << endl;
      cout << "Universal Longitude = " << ugm3.UniversalLongitude() << endl;
