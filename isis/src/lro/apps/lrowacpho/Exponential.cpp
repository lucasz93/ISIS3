...
namespace Isis {
     ...
     *         parameters
     */
    double Exponential::photometry ( NaifContextPtr naif, double i, double e, double g, int band ) const {
        // Test for valid band
     ...
     */
    double Exponential::photometry ( NaifContextPtr naif, const Parameters &parms, double i, double e, double g ) const {
     ...
     */
    Exponential::Parameters Exponential::findParameters ( NaifContextPtr naif, const double wavelength ) const {
     ...
     */
    Exponential::Parameters Exponential::extract ( NaifContextPtr naif, const DbProfile &p ) const {
        Parameters pars;
     ...
     */
    void Exponential::init ( NaifContextPtr naif, PvlObject &pvl, Cube &cube ) {
